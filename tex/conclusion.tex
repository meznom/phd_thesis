...
With the Ising approximation, stochastic series expansion Monte Carlo techniques
...
% TODO: mentions robustness with respect to perturbations?; QCA is more fragile
% than previously found
% we identified optimal parameters (kind of)
