...
inhibited by the fundamental physical limits of the \cgls{MOSFET}. Simply put,
...
First, some device proposals seek to incrementally improve the \cgls{MOSFET}.
...
transistor. They would be a drop-in replacement for \cglspl{MOSFET}, and the
...
mature technology that could rival \cgls{CMOS}, and there is also no obvious
...
magnetic domain. \cGls{MQCA} \cite{cowburn2000room, bernstein2005magnetic},
occasionally referred to as \cgls{NML} \cite{cavin2012science}, employ bistable
nanomagnets as cells which are coupled through magnetic instead of electrostatic
fields. \cGls{MQCA} works at room temperature, promises very low power
...
stabilize \cgls{QCA} \cite{blair2013environmental}, the fact remains that the
approximation underlying most theoretical work on \cgls{QCA} is not well
